  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 relative">
      ...
      <div className="relative z-10">
        ...
        <footer className="relative mt-20 pb-0">
          <div className="absolute inset-0 bg-gradient-to-br from-[#00417e] via-[#0052a3] to-[#00417e]"></div>
          ...
          {/* Extended blue background to prevent white space at bottom */}
          <div className="absolute inset-x-0 -bottom-20 h-20 bg-gradient-to-br from-[#00417e] via-[#0052a3] to-[#00417e]"></div>
        </footer>
      </div>
    </div>
  );
